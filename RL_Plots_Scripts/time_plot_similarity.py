...
# Read data from CSV
data = pd.read_csv('times_similarity.csv')
...
ax.set_title('Mean Time of 50 Simulations for Similarity-based Visit Sharing', fontweight='bold')
...
plt.savefig('images/Similarity Time Plot.png')